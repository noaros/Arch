...
Once in the system, it becomes a matter of how little I need to add to it to get it to behave acceptably. At first I tried to roll with virtual consoles only and no window manager, but copy paste between the consoles and browser seemed to be too annoying to get working. So I opted to give *Sway* a try, and like it so far. Touchpad scroll direction was annoying, but fixed with Sway configuration file.

Next problem was sound.
